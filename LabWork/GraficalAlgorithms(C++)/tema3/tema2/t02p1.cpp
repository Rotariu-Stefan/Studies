...
void Display3()
{
	...
	*/
	...
	gc->drawLine(10,10,20,15);	//q1
	gc->drawLine(10,10,15,20);

	gc->drawLine(10,10,10,20);
	//...
	gc->drawLine(10,10,15,0);	//q4
	gc->drawLine(10,10,20,5);


	gc->drawLine(10,10,0,15);
	gc->drawLine(10,10,0,5);
	gc->drawLine(10,10,5,20);
	gc->drawLine(10,10,5,20);
...
void Display5()
{
	...
	glColor3f(1,0,0);
	glBegin(GL_LINE_STRIP);
	for(double t=-pi/2;t<pi/2;t+=0.05)
	{
		printf("\nX: %f, \nY: %f",p3x(a,t),p3y(a,t));
